...
Save the data set into individual data frames.
...
Join Activity with Activity Labels to load activityLabels

```{r Join Labels, echo=TRUE, message=FALSE, warning=FALSE}
...
Append dataSrc, subjectNames to the data tables

```{r Add Columns, echo=TRUE, message=FALSE, warning=FALSE}
...
Calculate and add Mean and SD for the measurements as new columns

```{r Mean and SD, echo=TRUE, message=FALSE, warning=FALSE}
...
Create a dataset with averages of each measurement for each subject and activity combination

```{r Avg Dataset, echo=TRUE, message=FALSE, warning=FALSE}
